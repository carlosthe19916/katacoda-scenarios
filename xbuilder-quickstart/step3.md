...
```shell
cat << EOF > xbuilder-quickstart/org/openubl/xbuilder/ConfigDefaults.java
...
La versión final del archivo `xbuilder-quickstart/org/openubl/xbuilder/ConfigDefaults.java` debe de ser:
